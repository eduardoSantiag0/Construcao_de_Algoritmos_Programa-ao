...
int main (void)
{
    ...
    do {
        if (tamanho >= N) { // Check if array is full
            N += 10; // Increase N by 10 for reallocation
            int *tempPtr = (int *)realloc(ptrInput, N * sizeof(int)); // Reallocate memory
